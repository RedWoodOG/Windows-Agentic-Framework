# Agent Architecture Deep Dive - Key Learnings for A9N

**Source**: Reference architecture analysis
**Date**: 2026-04-03
**Purpose**: Capture critical implementation details for A9N tools
...
## 🚀 Implementation Priorities for A9N
...
The reference architecture has **no sandbox on Windows** - this is a known limitation. Options for A9N:
