...
**Date**: 2026-04-03
**Purpose**: Capture session persistence, crash recovery, and lossless context switching for A9N
...
async function submitMessage(userMessage: string) {
  ...
  } else if (A9N_EAGER_FLUSH || A9N_IS_COWORK) {
    // Awaited + flushed
...
## 8. Implementation Checklist for A9N
