...
metadata:
  a9n:
    ...
    related_skills: [codex, a9n-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the A9N terminal. Claude Code is Anthropic's autonomous coding agent CLI.
