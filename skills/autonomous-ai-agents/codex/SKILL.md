...
metadata:
  a9n:
    ...
    related_skills: [claude-code, a9n-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the A9N terminal. Codex is OpenAI's autonomous coding agent CLI.
