...
Built for [A9N Agent](https://github.com/upstream/a9n-agent). Usable in any coding agent. Canonical source lives here; synced to [`upstream/a9n-agent/skills/creative/ascii-video`](https://github.com/upstream/a9n-agent/tree/main/skills/creative/ascii-video) via PR.
