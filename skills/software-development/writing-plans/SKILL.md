...
version: 1.1.0
author: A9N Agent (adapted from obra/superpowers)
license: MIT
metadata:
  a9n:
...
> **For A9N:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use A9N tools to understand the project:
