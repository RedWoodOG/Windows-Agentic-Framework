...
- Give it a title like "a9n-agent-<machine-name>"
...
elif [ -f ~/.a9n/.env ] && grep -q "^GITHUB_TOKEN=" ~/.a9n/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.a9n/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
