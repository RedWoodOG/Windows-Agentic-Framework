...
/// <summary>
/// Tests for the Agent class — used directly by the new A9NChatService
/// (PR replaced sidecar-based approach with direct in-process agent execution).
/// Agent.ChatAsync is the core method called by A9NChatService.SendAsync.
/// </summary>
[TestClass]
public class AgentTests
{
    ...
    /// Mirrors Anthropic/OpenRouter tool-calling behavior without live HTTP; guards A9NChatService path.
    /// </summary>
    [TestMethod]
