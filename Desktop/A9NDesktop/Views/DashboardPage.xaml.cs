...
public sealed partial class DashboardPage : Page
{
    ...
    private void LoadPlatformBadges()
    {
        ...
        // Messaging platforms
        AddBadge(PlatformBadges, "Telegram", A9NEnvironment.TelegramConfigured, "#2AABEE");
        AddBadge(PlatformBadges, "Discord", A9NEnvironment.DiscordConfigured, "#5865F2");
        AddBadge(PlatformBadges, "Slack", A9NEnvironment.SlackConfigured, "#4A154B");
        AddBadge(PlatformBadges, "WhatsApp", A9NEnvironment.WhatsAppConfigured, "#25D366");
        AddBadge(PlatformBadges, "Matrix", A9NEnvironment.MatrixConfigured, "#0DBD8B");
        AddBadge(PlatformBadges, "Webhook", A9NEnvironment.WebhookConfigured, "#F59E0B");
    ...
    {
        ProviderText.Text = A9NEnvironment.DisplayModelProvider;
        ModelNameText.Text = A9NEnvironment.DisplayDefaultModel;
        EndpointText.Text = A9NEnvironment.DisplayModelBaseUrl;
        LlmModelText.Text = A9NEnvironment.DisplayDefaultModel;
    }
    ...
    private async System.Threading.Tasks.Task CheckLlmStatusAsync()
    {
        try
        {
            var chatService = App.Services?.GetService<A9NChatService>();
    ...
    private void LaunchA9NChat_Click(object sender, RoutedEventArgs e)
    {
