...
/// <summary>
/// Static model catalog matching the official A9N Agent Python models.py
...
public static class ModelCatalog
{
    ...
    /// Sourced from a9n_cli/models.py (_PROVIDER_MODELS) and agent/model_metadata.py (DEFAULT_CONTEXT_LENGTHS).
    /// </summary>
