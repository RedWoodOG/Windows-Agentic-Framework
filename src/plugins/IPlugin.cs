...
/// <summary>
/// Plugin interface for extending A9N with external providers.
...
public interface IPlugin
{
    ...
    /// <summary>Called once after registration. Receives a9nHome for path resolution.</summary>
...
{
    public required string A9NHome { get; init; }
