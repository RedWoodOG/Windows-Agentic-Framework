namespace A9N.Agent.Coordinator;

using A9N.Agent.Agents;
using A9N.Agent.Briefs;
...
public sealed class CoordinatorService
{
    ...
    public bool IsCoordinatorMode() =>
        Environment.GetEnvironmentVariable("A9N_COORDINATOR_MODE") == "true";
...
- Keep subtask count reasonable (2-8)";
    ...
    public string? MatchSessionMode(string? sessionMode)
    {
        ...
        Environment.SetEnvironmentVariable("A9N_COORDINATOR_MODE", sessionMode == "coordinator" ? "true" : null);
