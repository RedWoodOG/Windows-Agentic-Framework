...
public sealed class DreamConfig
{
    ...
    public static DreamConfig Load()
    {
        ...
        var enabled = Environment.GetEnvironmentVariable("A9N_DREAM_ENABLED");
        var minSessions = Environment.GetEnvironmentVariable("A9N_DREAM_MIN_SESSIONS");
        var minHours = Environment.GetEnvironmentVariable("A9N_DREAM_MIN_HOURS");
