...
public sealed class TranscriptStore
{
    ...
    public TranscriptStore(string transcriptsDir, bool eagerFlush = false)
    {
        ...
        _eagerFlush = eagerFlush || Environment.GetEnvironmentVariable("A9N_EAGER_FLUSH") != null;
    ...
    /// This is what makes A9N crash-proof.
    /// </summary>
...
public sealed class SessionNotFoundException : Exception
{
    public SessionNotFoundException(string sessionId) 
        : base($"Session '{sessionId}' not found. Use 'a9n list' to see available sessions.")
    {
    }
}
