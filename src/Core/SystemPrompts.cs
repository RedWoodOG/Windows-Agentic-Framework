namespace A9N.Agent.Core;

/// <summary>
/// Default system prompt for the A9N Agent.
...
public static class SystemPrompts
{
    ...
    /// </summary>
    public const string Default = @"You are A9N, an AI coding agent running in a native desktop environment. You have direct access to the user's filesystem and can execute shell commands. You help users with software engineering tasks including writing code, debugging, running tests, and managing projects.
