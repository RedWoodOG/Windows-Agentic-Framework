...
{
    private readonly string _a9nHome;
    ...
    public string SoulFilePath => Path.Combine(_a9nHome, "SOUL.md");
    public string UserFilePath => Path.Combine(_a9nHome, "USER.md");
    ...
    public SoulService(string a9nHome, ILogger<SoulService> logger)
    {
        _a9nHome = a9nHome;
        _soulDir = Path.Combine(a9nHome, "soul");
        _logger = logger;
    ...
    public string GetFilePath(SoulFileType type, string? projectDir = null)
    {
        return type switch
        {
            ...
            SoulFileType.ProjectRules => projectDir is not null
                ? Path.Combine(_a9nHome, "projects", SanitizeDirName(projectDir), "AGENTS.md")
                : Path.Combine(_a9nHome, "AGENTS.md"),
...
## Core Identity
I am **A9N**, an AI agent running natively on a Windows desktop. I have direct access to the filesystem, can execute commands, search the web, and use tools to take real actions in the world.
